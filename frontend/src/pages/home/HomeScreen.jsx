...
const HomeScreen = () => {
  ...
  return (
    <>
      ...
      {/* // this is the overlay for the image */}
      ...
      {/* This is the code for the title and the description of the movie or tv */}
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-lg">
            {/* // here the line split is just splitting the date and we are getting the year of the movie or tv show */}
    ...
    {/* // this is the div foe the slideres of the movies and tv shows */}
